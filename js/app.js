...
let cards = ['beer', 'beer', 'fighter-jet', 'fighter-jet', 'laptop', 'laptop', 'globe', 'globe', 'truck', 'truck', 'hourglass-o', 'hourglass-o', 'android', 'android', 'linux', 'linux'];
...
function createCard() {
  ...
  cards.forEach(function(card) {
    var cardElem = '<li><i class="card fa fa-' + card + '"></i></li>';
  ...
  $(".card").on("click", function() {
    ...
    if (openCard.length === 2) {
      if (openCard[0][0].classList[2] === openCard[1][0].classList[2]) {
        openCard[0][0].classList.add("rubberBand", "match");
        openCard[1][0].classList.add("rubberBand", "match");
        ...
        // If classes don't match, add "wrong" classru
        openCard[0][0].classList.add("wobble", "wrong");
        openCard[1][0].classList.add("wobble", "wrong");
...
function removeClasses() {
  $(".card").removeClass("show open flipInY rubberBand wobble wrong");
  removeOpenCards();
}
